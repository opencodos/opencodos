...
- If transcript or messages contain Google Drive/Notion links — attempt to read via MCP:
  ```
  Use Drive MCP: drive_get_file to access document by ID
  Use notion-fetch tool directly (Official Notion MCP) to read [URL]
  ```
