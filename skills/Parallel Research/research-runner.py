...
Read the tweet content carefully. If the tweet links to a repo, article, demo, or tool — follow the most important link (max 2 hops) and read that too.
...
def update_research_list(item_raw: str, output: Path) -> None:
    ...
    if updated != text:
        ...
        print(f"Updated Research List: crossed off item")
    else:
        print(f"Warning: could not find item in list to update")
