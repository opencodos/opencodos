...
CENTRAL_ENV = PathLib(os.environ.get("ATLAS_ENV_FILE", str(PathLib(__file__).parents[2] / "dev" / "Ops" / ".env")))
load_dotenv(CENTRAL_ENV)

from backend.connector.settings import settings as _settings
...
@validate_id("chat_id")
async def send_file(chat_id: int | str, file_path: str, caption: str = None) -> str:
    """
...
async def promote_admin(group_id: int | str, user_id: int | str, rights: dict = None) -> str:
    """
