...
SERVICES = {
    ...
    "connector-backend": {
        "label": "com.codos.connector-backend",
        "type": "daemon",
    ...
    "connector-frontend": {
        "label": "com.codos.connector-frontend",
        "type": "daemon",
        "category": "Running Services",
    ...
    "telegram-agent": {
        "label": "com.codos.telegram-agent",
        "type": "daemon",
        "category": "Running Services",
