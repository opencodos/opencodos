...
| Plist | Purpose |
|-------|---------|
| `com.atlas.telegram-agent` | Telegram agent server |
| `com.atlas.telegram-bot` | Atlas Telegram bot |
| `com.atlas.connector-backend` | Connector status backend |
| `com.atlas.connector-frontend` | Connector UI (Vite) |
