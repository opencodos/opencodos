...
const ERROR_PATTERNS: [RegExp, string][] = [
  [/PIPEDREAM_ACCOUNT_ID/i, 'OAuth account not connected'],
...
export function FirstSyncStep({ connectors, onSyncComplete }: FirstSyncStepProps) {
  ...
  useEffect(() => {
    return () => {
      if (pollingRef.current && connectors.includes('telegram')) {
