...
export function AgentDashboard() {
  ...
  // Handle agent selection: update active agent, track mounted agents, fetch detail
  const handleAgentSelect = useCallback((agentId: string) => {
    ...
    if (agentId === 'claude' || agentId === 'dashboard') {
      setSelectedAgentDetail(null)
    } else {
      agentConfigAPI.getAgent(agentId)
