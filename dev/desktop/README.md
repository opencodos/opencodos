...
- `connector-backend` (`src/backend/connector/server.py`) — autostart
- `telegram-agent-api` (`src/backend/telegram_agent/server.py`) — autostart
- `atlas-bot` (`src/backend/atlas_bot/bot.py`) — manual start
- `telegram-mcp-server` (`src/backend/telegram_mcp/main.py`) — manual start
