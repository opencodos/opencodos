...
- `connector-backend` (`backend/connector/server.py`) — autostart
- `telegram-agent-api` (`backend/telegram_agent/server.py`) — autostart
- `atlas-bot` (`backend/atlas_bot/bot.py`) — manual start
- `telegram-mcp-server` (`backend/telegram_mcp/main.py`) — manual start
