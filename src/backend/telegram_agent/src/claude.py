...
TOOLS = [
    {
        ...
        "description": "Send a message to a Telegram conversation. IMPORTANT: Always confirm with the user before sending unless they explicitly said 'send' or 'tell them'.",
        "input_schema": {
            "type": "object",
            "properties": {
                "conversation_name": {
...
IMPORTANT RULES:
- When the user asks to send a message, ALWAYS confirm with them before actually sending, showing the exact message and recipient
...
class ClaudeAssistant:
    ...
    def __init__(
        ...
        self.pending_send: dict | None = None  # Track pending message to send
