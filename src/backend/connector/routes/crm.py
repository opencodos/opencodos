...
class Contact(BaseModel):
    ...
    deal_stage: str | None = None  # first_contact | call | negotiation | closed_won | closed_lost
...
async def get_pipeline():
    ...
    stage_order = ["to_connect", "first_contact", "call", "negotiation", "closed_won", "closed_lost"]
